...
area calculation, perimeter, and string representations.
"""
...
class Rectangle:
    ...
    def __repr__(self):
        ...
        Should be able to recreate the object using eval().

        Returns:
            str: Representation string in the form: Rectangle(width, height)
        """
